         ...
         <tr>
            <td bgcolor="#FFFFFF" style="padding:15px; border:1px solid #e5e5e5;">
               <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                     <td style="text-align:center; color:#fff;background-color:#2a2a2a; padding-bottom:10px;"> Copyright {{ date("Y") }} by <a href="#" style="text-align:center; color:#fff;">{{ strtolower(config('app.project.name')) }}.cl</a> All Right Reserved.
