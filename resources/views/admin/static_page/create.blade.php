              ...
              <div id="myTabContent1" class="tab-content">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-4 controls">
                    ...
                    @if($lang['locale'] == 'en')        
                        {!! Form::text('page_title_'.$lang['locale'],old('page_title_'.$lang['locale']),['class'=>'form-control','data-rule-required'=>'true','data-rule-maxlength'=>'255','placeholder'=>'Page Title']) !!}
                    @else
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-4 controls">
                    ...
                    @if($lang['locale'] == 'en')        
                        {!! Form::text('meta_keyword_'.$lang['locale'],old('meta_keyword_'.$lang['locale']),['class'=>'form-control','data-rule-required'=>'true','data-rule-maxlength'=>'255','placeholder'=>'Meta Keyword']) !!}
                    @else
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-4 controls">
                    ...
                    @if($lang['locale'] == 'en')        
                        {!! Form::text('meta_desc_'.$lang['locale'],old('meta_desc_'.$lang['locale']),['class'=>'form-control','data-rule-required'=>'true','data-rule-maxlength'=>'255','placeholder'=>'Meta Description']) !!}
                    @else
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-8 controls">
                    ...
                    @if($lang['locale'] == 'en')        
                        {!! Form::textarea('page_desc_'.$lang['locale'],old('page_desc_'.$lang['locale']),['class'=>'form-control','data-rule-required'=>'true','data-rule-maxlength'=>'1000','placeholder'=>'Page Content']) !!}
                    @else
