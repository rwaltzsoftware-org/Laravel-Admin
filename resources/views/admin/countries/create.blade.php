          ...
          <div  class="tab-content">
            ...
            <div class="tab-pane fade {{ $lang['locale']=='en'?'in active':'' }}" 
              ...
              <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label" for="state"> Code 
                  <i class="red">*
                  </i>
                </label>
                <div class="col-sm-6 col-lg-4 controls">
                  @if($lang['locale'] == 'en')        
                  {!! Form::text('country_code',old('country_code'),['class'=>'form-control','data-rule-required'=>'true','data-rule-maxlength'=>'255', 'placeholder'=>'Code']) !!}
                  @endif    
                </div>
