    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box-content">
          ...
          <div class="btn-group">
          <a href="{{ $module_url_path.'/create' }}" class="btn btn-primary btn-add-new-records" title="Add New Property Type">Add {{ isset($module_title)?str_singular($module_title):'' }}</a> 
          </div>
