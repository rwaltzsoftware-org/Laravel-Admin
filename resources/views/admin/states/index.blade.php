    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box-content">
          ...
          <div class="btn-group">
          <a href="{{ $module_url_path.'/create'}}" class="btn btn-primary btn-add-new-records">Add New state</a> 
          </div>
              ...
              <tbody>
                ...
                @if(isset($arr_data) && sizeof($arr_data)>0)
                  ...
                  <tr>
                    ...
                    <td  > {{ $data['country_details']['country_name'] }} </td> 

                     <td>
                      @if($data['is_active']==1)
                        <a href="{{ $module_url_path.'/deactivate/'.base64_encode($data['id']) }}" class="btn btn-success">Active</a>
                      @else
                        <a href="{{ $module_url_path.'/activate/'.base64_encode($data['id']) }}" class="btn btn-danger">Inactive</a>
                      @endif
